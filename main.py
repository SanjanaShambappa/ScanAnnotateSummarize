...
Input : 
    Dataset :
        ...
        [The image files are annotated to highlight the textual content by drawing bounding boxes. The bounding boxes are named as BB1, BB2, ...and so on. 
        The co-ordinates of the bounding boxes are saved as an xml file]. 
    Python files:
...
This method compares the model summary (generated by extractive algorithms) with 
the reference summary (generated by the abstractive algorithm) and generates a score'''
