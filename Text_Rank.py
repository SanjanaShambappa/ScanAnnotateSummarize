...
File Name : Text_Rank.py
Description :
This notebook performs extractive summarization using Text Rank.  
Input : 
...
def run_summarization(text_string, sentence_count):
      text_summary = TextRank4Sentences()
      text_summary.analyze(text_string)
      return text_summary.get_top_sentences(sentence_count)